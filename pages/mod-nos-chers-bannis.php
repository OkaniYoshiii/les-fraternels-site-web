...
<?php include_once "../components/header.php"; ?>
    <main>
        <section class="hero-banner text-centered" style="--mod-banner: url(../images/mods/mod-thumbnail-banrewind-1920x1080.webp);">
        ...
        <section>
            <div class="narrow">
                ...
                <img src="/images/mods/mod-thumbnail-banrewind-1920x1080.webp" width="1920" height="1080" alt="Un groupe de 3 zombies attaquant un joueur. Les zombies ont un nom de joueur ayant été banni affiché au dessus de leur tête.">
            </div>
        </section>
    </main>
