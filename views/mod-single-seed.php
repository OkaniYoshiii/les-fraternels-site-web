...
<?php include_once "../components/header.php"; ?>
    <main>
        <section class="hero-banner text-centered" style="--mod-banner: url(../images/mods/mod-thumbnail-single-tree-min-1920x1080.webp);">
            <div class="hero-filter">
                ...
                <div class="mod-infos">
                    <div class="medium mod-infos-wrapper">
                        ...
                        <div class="mod-info">
                            <p>Date de publication: <span><time datetime="2023-07-20">20/07/2023</time></span></p>
                        </div>
                        <div class="mod-info">
