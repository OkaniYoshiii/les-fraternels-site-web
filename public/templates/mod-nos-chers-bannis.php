    ...
    <main>
        ...
        <section>
            <div class="narrow">
                ...
                <img src="<?= SITE_URL . IMG_DIR ?>/mod-thumbnail-banrewind-min-1920x1080.webp" width="1920" height="1080" alt="Un groupe de 3 zombies attaquant un joueur. Les zombies ont un nom de joueur ayant été banni affiché au dessus de leur tête.">
            </div>
        </section>
    </main>
