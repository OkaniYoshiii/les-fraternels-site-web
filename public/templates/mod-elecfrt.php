    ...
    <main>
        ...
        <section>
            <div class="narrow">
                ...
                <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-small-engine-1234x873.webp" width="1234" height="873" alt="Générateur de chantier du mod ElecFRT.">
                <blockquote>
                <p>Capacité du Réservoir : 1500
                Capacité énergétique maximale : 1500W</p>
                </blockquote>
                <p><b>Générateur industriel </b></p>
                <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-big-engine-1920x1080.webp" width="1920" height="1080" alt="Générateur industriel du mod ElecFRT.">
                <blockquote>
                ...
                <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-craft-530x345.webp" alt="">
                ...
                <div class="two-columns">
                    <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-craft-3-526x344.webp" width="526" height="644" alt="Recette de fabrication d'un panneau solaire du mod ElecFRT.">
                    <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-craft-4-527x348.webp" width="527" height="348" alt="Recette de fabrication d'un groupe solaire du mod ElecFRT.">
                </div>
                ...
                <img src="<?= SITE_URL . IMG_DIR ?>/mod-elecbdr-fence-1920x1080.webp" width="1920" height="1080" alt="Une barrière enflammée rajoutée par le mod ElecFRT.">
            </div>
        </section>
    </main>  
