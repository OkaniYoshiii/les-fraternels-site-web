...
<?php require_once COMPONENTS_DIR . '/default-metatags.php' ?>
    ...
    <meta name="description" content="Regroupe l'ensemble des liens pratiques et à connaitre afin de pouvoir jouer sereinement au sein de notre communauté. Discord, Livemaps et sites de votes sont regroupés pour vous sur cette page.">
    <link rel="stylesheet" href="/css/liens-utiles.css">
</head>
<body class="no-js">
        ...
        <section>
            <div class="narrow">
                ...
                <section>
                    ...
                    <img src="<?= IMG_OTHER_DIR ?>/discord-1920x1035.webp" width="1920" height="1035" alt="">
                ...
                <section>
                    ...
                    <h3>Live map N°1</h3>
                    <img src="<?= IMG_OTHER_DIR ?>/livemap-1-1878x932.webp" width="1878" height="932" alt="">
                    ...
                    <h3>Live map N°2</h3>
                    <img src="<?= IMG_OTHER_DIR ?>/livemap-2-1880x933.webp" width="1880" height="933" alt="">
                ...
                <section>
                    ...
                    <h3>TopServeurs</h3>
                    <img src="<?= IMG_OTHER_DIR ?>/topservers-900x442.webp" width="900" height="442" alt="">
                    ...
                    <img src="<?= IMG_OTHER_DIR ?>/7daystodie-servers-896x443.webp" width="896" height="443" alt="">
