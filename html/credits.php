...
<body class="no-js">
    ...
    <main>
        <section>
            <div>
                <h1 class="narrow">Crédits</h1>
                <section>
                    <h2 class="narrow">Crédits photograhiques</h2>      
                ...
                <section>
                    <div class="narrow">
                        ...
                        <h4>Extensions</h4>
                        <p>Les extensions sont une grosse partie de VsCode. Il y en a pour tout les gouts et permettent vraiment d'augmenter sa productivité. Etant donné que la plupart des extensions de VsCode sont réalisées par la communauté, je me devais de remercier toutes ces incroyables personnes qui ont augmenter considérablement ma productivité.</p> 
                        <p>Les principales extensions que j'ai utilisé pour réaliser ce site sont donc :</p>
                        <dl>
                            <dt><a href="https://marketplace.visualstudio.com/items?itemName=figma.figma-vscode-extension" target="_blank">Figma for VsCode</a></dt>
                            <dd>Cette extension vous permet d'avoir accès à votre design réalisé sur Figma directement depuis VsCode. L'extension est super simple d'utilisation, elle permet de copier le CSS fournit par Figma dans vos fichiers de façon rapide et évite de devoir constamment osciller entre navigateur et VsCode.</dd>
                            <dt><a href="https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer" target="_blank">Live Server</a></dt>
                            <dd>Live Server fait partie de ces extensions qui sont devenues indispensables pour travailler correctement. Elle permet en un clic de lancer un version en direct de votre site internet et de mettre à jour celui-ci à chaque fois que vous mettez à jour votre code. Plus de besoin de recharger la page à chaque fois que vous changez la moindre ligne.</dd>
                            <dt><a href="https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one" target="_blank">Markdown All in One</a></dt>
                            <dd>Le Markdown est un langage formidable : très facile à apprendre et capable de sauver une masse de temps car ses fichiers sont transcriptibles en d'autres langages comme l'HTML et est aussi utilisé sur Discord par exemple. Ecrire un pavé de texte sur Discord peut donc être réutilisé pour un site internet mais pour cela, il faut transcrire le Markdown de Discord en HTML et c'est exactement ce que propose cette extension (entre autres).</dd>
                            <dt><a href="https://marketplace.visualstudio.com/items?itemName=ms-vscode.PowerShell" target="_blank">Powershell</a></dt>
                            <dd>Je ne fais pas de Powershell donc impossible de vous dire si cette extension est efficace pour cela. Ceci dit, Powershell propose un thème clair très attirant pour écrire du Javascript je trouve et c'est donc pour cette raison que j'ai utilisé cette extension.</dd>
                            <dt><a href="https://marketplace.visualstudio.com/items?itemName=jsaulou.theme-by-language" target="_blank">Theme By Language</a></dt>
