...
<?php include_once COMPONENTS_DIR . "/header.php"; ?>
    <main>
        <section class="hero-banner text-centered" style="--mod-banner: url(../images/mods/mod-thumbnail-sticky-landmine-min-1920x1080.webp);">
            <div class="hero-filter">
                <div class="medium hero-title">
                    <h1>Refonte Mines Terrestres</h1>
                    <p class="mod-category">Ajout de contenu, Pièges</p>
                </div>
                <div class="mod-infos">
                    <div class="medium mod-infos-wrapper">
                        ...
                        <div class="mod-info">
                            <p>Date de publication: <span><time datetime="2023-09-29">29/09/2023</time></span></p>
                        </div>
                        <div class="mod-info">
