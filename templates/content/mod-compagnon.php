        ...
        <section class="hero-banner text-centered" style="--mod-banner: url(../images/mods/mod-thumbnail-compagnon-min-730x673.webp);">
            <div class="hero-filter">
                <div class="medium hero-title">
                    <h1>Mod Compagnon</h1>
                    <p class="mod-category">Général</p>
                </div>
                <div class="mod-infos">
                    <div class="medium mod-infos-wrapper">
                        <div class="mod-info">
                            <p>Auteur: <span>Arcueid-Gray Sage</span></p>
                        </div>
                        <div class="mod-info">
                            <p>Date de publication: <span><time datetime="2023-03-31">31/03/2023</time></span></p>
                        </div>
                        <div class="mod-info">
